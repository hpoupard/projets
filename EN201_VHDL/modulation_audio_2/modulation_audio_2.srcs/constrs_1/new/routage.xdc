...
set_property PACKAGE_PIN A11 [get_ports SORTIE]					
	set_property IOSTANDARD LVCMOS33 [get_ports SORTIE]
##Bank = 15, Pin name = IO_L6P_T0_15,						Sch name = AUD_SD
set_property PACKAGE_PIN D12 [get_ports SORTIE_EN]						
	set_property IOSTANDARD LVCMOS33 [get_ports SORTIE_EN]


##USB-RS232 Interface
##Bank = 35, Pin name = IO_L7P_T1_AD6P_35,					Sch name = UART_TXD_IN
set_property PACKAGE_PIN C4 [get_ports UART]						
